  ...
  return (
    <header className="header">
      <div className="header-top" id="header-top">
        <a href="">
          <img src="/assets/logo-bookmark.svg" alt="Site logo" />
        </a>
        <button className="header-hamburger" id="header-hamburger">
          <img src="/assets/icon-hamburger.svg" alt="Hamburger menu icon" />
        </button>
      </div>
      <nav className="header-nav" aria-hidden="true" id="header-nav">
        <div className="header-nav-top">
          <a href="" className="header-mobile-logo">
          ...
          <button className="header-close" id="header-close">
            <img src="/assets/icon-close.svg" alt="Close close icon" />
          </button>
        </div>
        <ul className="header-nav-items">
          ...
          <li className="header-nav-item">
            <a href="" className="btn outlined full">
              Login
            </a>
          </li>
        </ul>
